    ...
    <>
      <div className='h-[100vh] bg-purple-700'>
        <div className='grid lg:grid-cols-4 md:grid-cols-4 grid-cols-1 p-3 pt-8'>
          <div className='bg-white lg:col-start-2 lg:col-end-4 md:col-start-2 md:col-end-4 sm:col-start-1 sm:col-end-4 p-6'>
            <div className='bg-purple-700 p-4 text-center shadow-lg'>
              ...
              <button onClick={() => addItem()} className='setBtn md:text-[15px] lg:text-lg bg-white md:w-[26%] lg:w-[26%] mt-2  p-2 ms-3 hover:bg-orange-400 hover:text-white'>Add Task</button>
            </div>
          </div>
        </div>
        <div className='grid lg:grid-cols-4 md:grid-cols-4 grid-cols-1 p-3 pt-8'>
