            ...
            <nav class="bg-[#122E99] text-white dark:bg-gray-900 px-[5%] md:px-[10%]">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link href="/" class="flex items-center">
                        <span class="uppercase text-xl sm:text-3xl font-bold hover:text-sky-500 transition-all delay-100">Logo.</span>
                    </Link>
                    <button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg md:hidden hover:text-sky-500 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
                    ...
                    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul class="text-sm flex flex-col md:items-center p-4 md:p-0 rounded-lg bg-[#122E99] md:flex-row md:space-x-4 space-y-3 md:space-y-0 md:mt-0 md:border-0 md:bg-[#122E99] dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                                <Link href="/" className="hover:text-sky-500 hover:underline transition-all delay-100">Home</Link>
                            </li>
                            <li>
                                <Link href="/about" className="hover:text-sky-500 hover:underline transition-all delay-100">About</Link>
                            </li>
                            <li>
                                <Link href="/pages" className="hover:text-sky-500 hover:underline transition-all delay-100">Pages</Link>
                            </li>
                            <li>
                                <Link href="/services" className="hover:text-sky-500 hover:underline transition-all delay-100">Services</Link>
                            </li>
                            <li>
                                <Link href="/portfolio" className="hover:text-sky-500 hover:underline transition-all delay-100">Portfolio</Link>
                            </li>
                            <li>
                                <Link href="/blog" className="hover:text-sky-500 hover:underline transition-all delay-100">Blog</Link>
                            </li>
                            <li>
                                <Link href="/contact" className="hover:text-sky-500 hover:underline transition-all delay-100 pe-0 lg:pe-7">Contact</Link>
                            </li>
                            <li>
